...
-(id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    if(self){
        ...
        //屏蔽界面
        BOOL needHide =([self isKindOfClass:[ScrollQuickController class]]||[self isKindOfClass:[ScrollTimingController class]]);
        
        if(!needHide)
        {
            NSString * vcDes = [self classNameForKMRecord];
            
            [KMStatis staticApplicationVCinitWithVCClassDes:vcDes];
        }
    }
    return self;
}
...
//        _loadingHud.hudBgColor = [UIColor clearColor];
//        _loadingHud.labelText = @"Loading...";
//        _loadingHud.labelText = @"请稍后...";
...
{
    UIViewController * controller = self.viewDeckController.navigationController;
