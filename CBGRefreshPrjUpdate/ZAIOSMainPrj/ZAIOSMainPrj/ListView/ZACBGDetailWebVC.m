...
- (void)viewDidLoad {
    ...
    NSString * urlString = self.listData.detailWebUrl;
    ...
    NSString * string = self.listData.detaiModel.equip_desc;
...
//    string = @"{\"AllEquip\":{6:{\"iType\":1252,\"cDesc\":\"#r等级 100  五行 金#r#r命中 +360 伤害 +310#r耐久度 335#r#G#G耐力 -6#Y #G力量 +20#Y#Y#r#W制造者：′此人无心#Y  \"},4:{\"iType\":2852,\"cDesc\":\"#r等级 100  #r灵力 +161#r耐久度 421#r锻炼等级 5  镶嵌宝石 舍利子#Y#r#W制造者：′溺水㈢千ら强化打造#Y  \"},10:{\"iType\":2906,\"cDesc\":\"#r等级 40  #r气血 +120 防御 +22#r耐久度 300#r锻炼等级 1  镶嵌宝石 光芒石#Y#r#c4DBAF4特效：#c4DBAF4永不磨损#Y  \"},2:{\"iType\":2652,\"cDesc\":\"#r等级 100  五行 土#r#r防御 +237#r耐久度 131  修理失败 2次#r锻炼等级 4  镶嵌宝石 月亮石#r#G#G耐力 -3#Y #G体质 +20#Y#Y#r#W制造者：我累哦强化打造#Y#r#Y熔炼效果：#r#Y#r+17防御#Y  \"},1:{\"iType\":2552,\"cDesc\":\"#r等级 100  五行 水#r#r防御 +93 魔法 +110#r耐久度 240#r锻炼等级 3  镶嵌宝石 月亮石#Y#r#W制造者：vip‖烟强化打造#Y  \"}}}";
    string = self.listData.detaiModel.equip_desc;
...
//    NSString * orderSN = self.listData.game_ordersn;
    NSString * txtValue = self.listData.detailWebUrl;
    NSLog(@"detailWebUrl %@",txtValue);
    UITextView * txt = [[UITextView alloc] initWithFrame:CGRectMake(0, SCREEN_HEIGHT - 80, SCREEN_WIDTH, 80)];
    [self.view addSubview:txt];
    txt.text = txtValue;
    
    NSString * prePrice = self.listData.detaiModel.equipExtra.detailPrePrice;
...
-(void)submit
{
    NSString * string = [self.listData.detaiModel.equipExtra createExtraPrice];
...
#pragma mark RefreshEquipListDataManager
...
//    NSArray * latest = [dbManager latestLocalSaveEquipModelArray];
//    
//    for (Equip_listModel * eve in latest)
//    {
//        if(!eve.detaiModel)
//        {
//            [self startRequestWithEquipModel:eve];
//        }
//    }
//    
//    [self refreshDataForListTableView];
