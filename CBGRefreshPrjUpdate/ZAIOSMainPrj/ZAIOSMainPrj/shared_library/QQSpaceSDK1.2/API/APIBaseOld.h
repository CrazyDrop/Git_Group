...
/*!
 @class       APIBaseOld 
 @superclass  NSObject <TencentRequestOldDelegate>{ TencentRequestOld* _request; NSString* _httpMethod; id _target; SEL _selector; int _seq; }
 
 */
@interface APIBaseOld : NSObject <TencentRequestOldDelegate>{
