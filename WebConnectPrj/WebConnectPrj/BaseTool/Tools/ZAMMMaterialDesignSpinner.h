...
//! Project version number for ZAMMMaterialDesignSpinner.
FOUNDATION_EXPORT double ZAMMMaterialDesignSpinnerVersionNumber;

//! Project version string for ZAMMMaterialDesignSpinner.
FOUNDATION_EXPORT const unsigned char ZAMMMaterialDesignSpinnerVersionString[];
 ...
 */
@interface ZAMMMaterialDesignSpinner : UIView
