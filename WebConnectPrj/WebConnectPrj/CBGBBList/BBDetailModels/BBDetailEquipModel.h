...
@interface BBDetailEquipModel : NSObject
...
@property (nonatomic, strong) NSNumber *cross_server_poundage;
...
@property (nonatomic, strong) NSString *cross_server_poundage_desc;
...
// @property (nonatomic, strong) Null *bargain_info;
...
@property (nonatomic, strong) NSNumber *bargain_accept_sms;
