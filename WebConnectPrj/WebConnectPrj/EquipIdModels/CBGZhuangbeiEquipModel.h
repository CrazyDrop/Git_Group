...
@interface CBGZhuangbeiEquipModel : CBGBaseEquipModel
...
@property (nonatomic, strong) NSString * effectiveSkill;
@property (nonatomic, strong, readonly) NSArray * skillsArr;
@property (nonatomic, assign) NSInteger appendProperty;
@property (nonatomic, assign) NSString * suitSkill;
@property (nonatomic, assign) NSInteger holeNum;
