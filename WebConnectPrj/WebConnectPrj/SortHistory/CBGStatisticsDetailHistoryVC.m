...
@property (nonatomic, strong) NSArray * sortArr;//分段数组、数组内包含数组，个数和tagArr一致
@property (nonatomic, strong) NSArray * tagArr;

//@property (nonatomic, assign) BOOL sortSchool;//以服务器分组、rate分组
//@property (nonatomic, assign) BOOL orderPrice;//以rate排序、价格排序

@property (nonatomic, assign) CBGStaticSortShowStyle sortStyle;//排序、分组 种类
@end
