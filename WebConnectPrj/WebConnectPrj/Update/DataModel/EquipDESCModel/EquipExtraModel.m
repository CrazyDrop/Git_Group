...
-(CGFloat)price_chongxiu{
    return [self.priceDelegate price_chongxiuWithExtraModel:self];
}
-(CGFloat)price_jineng{
    return [self.priceDelegate price_jinengWithExtraModel:self];
}
-(CGFloat)price_jingyan{
    return [self.priceDelegate price_jingyanWithExtraModel:self];
}
-(CGFloat)price_qiannengguo{
    return [self.priceDelegate price_qiannengguoWithExtraModel:self];
}
-(CGFloat)price_qianyuandan{
    return [self.priceDelegate price_qianyuandanWithExtraModel:self];
}
-(CGFloat)price_dengji{
    return [self.priceDelegate price_dengjiWithExtraModel:self];
}
-(CGFloat)price_jiyuan{
    return [self.priceDelegate price_jiyuanWithExtraModel:self];
}
-(CGFloat)price_menpai{
    return [self.priceDelegate price_menpaiWithExtraModel:self];
}
-(CGFloat)price_fangwu{
    return [self.priceDelegate price_fangwuWithExtraModel:self];
}
-(CGFloat)price_xianjin{
    return [self.priceDelegate price_xianjinWithExtraModel:self];
}
-(CGFloat)price_haizi{
    return [self.priceDelegate price_haiziWithExtraModel:self];
}
-(CGFloat)price_xiangrui{
    return [self.priceDelegate price_xiangruiWithExtraModel:self];
}
-(CGFloat)price_zuoji{
    return [self.priceDelegate price_zuojiWithExtraModel:self];
}
-(CGFloat)price_fabao{
    return [self.priceDelegate price_fabaoWithExtraModel:self];
}
