...
{
    if (delegate != NULL) {
        [delegate LYAlertdialogButtonTouchUpInside:self clickedButtonAtIndex:[sender tag]];
    }
...
- (void)customIOS7dialogButtonTouchUpInside: (LYAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
...
- (UIView *)createContainerView
{
    if (containerView == NULL) {
        containerView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 300, 195)];
    }
...
//    UIView *lineView = [[UIView alloc] initWithFrame:CGRectMake(5, dialogContainer.bounds.size.height- 20 - buttonHeight*[buttonTitles count] - buttonSpacerHeight, dialogContainer.bounds.size.width-10, buttonSpacerHeight)];
...
- (void)addButtonsToView: (UIView *)container
{
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        [closeButton setFrame:CGRectMake(0, (container.bounds.size.height -20- buttonHeight*[buttonTitles count])+i*buttonHeight, buttonWidth, buttonHeight)];
