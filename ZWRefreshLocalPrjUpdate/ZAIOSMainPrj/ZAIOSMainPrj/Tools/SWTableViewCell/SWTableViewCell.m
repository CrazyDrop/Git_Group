...
//    UIPanGestureRecognizer *panGesture = [[UIPanGestureRecognizer alloc] initWithTarget:self action:@selector(scrollPanGesture:)];
//    [cellScrollView addGestureRecognizer:panGesture];
...
-(void)scrollPanGesture:(UIPanGestureRecognizer *)ges
{
