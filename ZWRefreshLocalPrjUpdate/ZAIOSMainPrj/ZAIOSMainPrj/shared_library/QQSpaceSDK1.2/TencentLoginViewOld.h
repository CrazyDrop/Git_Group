...
/*!
 @protocol       TencentLoginViewOldDelegate;
 @discussion  TencentLoginViewOldDelegate
 */
@protocol TencentLoginViewOldDelegate;

/**
 * Do not use this interface directly, instead, use authorize in  TencentOAuthOld.h
 *
 */


/*!
 @class       TencentLoginViewOld 
 @superclass  UIView <UIWebViewDelegate> { id<TencentLoginViewOldDelegate> _delegate; NSMutableDictionary *_params; NSString * _serverURL; NSURL* _loadingURL; UIWebView* _webView; UIActivityIndicatorView* _spinner; UILabel* _titleLabel; UIButton* _closeButton; UIDeviceOrientation _orientation; BOOL _showingKeyboard; }
 
 */
@interface TencentLoginViewOld : UIView <UIWebViewDelegate> {
	id<TencentLoginViewOldDelegate> _delegate;
...
@property(nonatomic,assign) id<TencentLoginViewOldDelegate> delegate;
...
@property(nonatomic,copy)void(^dissmis)();
...
- (id)initWithURL: (NSString *) serverURL
         ...
         delegate: (id <TencentLoginViewOldDelegate>) delegate;
 ...
 */
/*!
 @protocol       TencentLoginViewOldDelegate <NSObject>
...
/*!
 ...
 @param      dialog dialog
 */
- (void)dialogDidComplete:(TencentLoginViewOld *)dialog;
...
/*!
 ...
 @param      dialog dialog
 */
- (void)dialogDidNotComplete:(TencentLoginViewOld *)dialog;
...
/*!
 ...
 @param      error error
 */
- (void)dialog:(TencentLoginViewOld*)dialog didFailWithError:(NSError *)error;
