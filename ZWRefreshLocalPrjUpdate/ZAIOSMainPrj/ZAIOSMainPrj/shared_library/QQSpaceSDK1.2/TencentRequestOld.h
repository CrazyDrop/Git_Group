...
@protocol TencentRequestOldDelegate;

/**
 * Do not use this interface directly, instead, use method in TencentOAuthOld.h
 */



/*!
 @class       TencentRequestOld 
 @superclass  NSObject { id<TencentRequestOldDelegate> _delegate; NSString* _url; NSString* _httpMethod; NSMutableDictionary* _params; NSURLConnection* _connection; NSMutableData* _responseText; }
 
 */
@interface TencentRequestOld : NSObject {
	id<TencentRequestOldDelegate> _delegate;
	NSString*             _url;
...
@property(nonatomic,assign) id<TencentRequestOldDelegate> delegate;
...
/*!
 ...
 @param      url url
 */
+ (TencentRequestOld*)getRequestWithParams:(NSMutableDictionary *) params
							 httpMethod:(NSString *) httpMethod
 ...
 */
@protocol TencentRequestOldDelegate <NSObject>
 ...
 */
- (void)requestLoading:(TencentRequestOld *)request;
...
/*!
 ...
 @param      data data
 */
- (void)request:(TencentRequestOld *)request didLoadRawResponse:(NSData *)data;
